...
def calculate_similarities(reference_mols, dataset_mols, combine_method="average", weight=(0.5, 0.5)):
    """
    Calculate similarity using ECFP and FCFP.
    combine_method: 'average' or 'weighted'
    weight: tuple for weighted average (ECFP_weight, FCFP_weight)
    """
    similarities = {}
...
def get_top_n(similarities, dataset_mols, n=5):
    """
    Return top N similar molecules for each reference
    """
    top_n_dict = {}
